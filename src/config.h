...
#define MAX_RECIVE_TRIES 5
#define MAX_SEND_FAILS 10

enum class AircraftStates
{
...
AircraftStates current_state = AircraftStates::IDEAL;
AircraftStates_transmitter current_state_transmitter = AircraftStates_transmitter::INITIALIZING;

// DEFINE the servo objects
Servo aileron_servo, elevator_servo, radder_servo, wheels_servo, throttle_esc;
...
void start(bool read_swicth)
{
    ...
    else
    {
        ...
        current_state = AircraftStates::CONFIG;
    }
}